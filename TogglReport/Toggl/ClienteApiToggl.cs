...
/// <summary>
/// Cliente da API v9 do Toggl Track. Autentica via HTTP Basic
/// (usuário = API Token, senha = literal "api_token").
/// </summary>
public class ClienteApiToggl
{
    ...
    /// <summary>Verifica se o token autentica (GET /me), antes de salvá-lo.</summary>
    ...
    /// <summary>Busca as time entries do período (inclusive). As datas devem estar em UTC.</summary>
